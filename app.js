...
const dossiersData = {
    pt: [
        ...
        { id: "pentagon_long", title: "Os 160 Arquivos Secretos do Pentágono", badge: "LEAKS GOVERNAMENTAIS", image: "images/ufo_investigation.png", shortDesc: "A liberação oficial de centenas de páginas de avistamentos de OVNIs documentados por militares de elite.", readTime: "4 min de leitura", fullContent: `<p><strong>O Dossiê:</strong> Em 2020, sob forte pressão do Congresso americano, o Pentágono liberou oficialmente relatos e avistamentos de Fenômenos Anômalos Não Identificados.</p><p><strong>O Mistério:</strong> Os dados brutos e fitas originais de radar sumiram logo após os incidentes. Os relatos citam manobras impossíveis e bloqueio eletromagnético.</p><p><em>Código de Acesso da Área 51: <strong>SEGRETO51</strong></em></p>` },
        { id: "stargate", title: "O Projeto Stargate", badge: "PROJETO SECRETO", image: "images/stargate_intro.png", shortDesc: "A unidade militar secreta dos EUA que tentou usar visão remota para espionar a União Soviética.", readTime: "5 min de leitura", fullContent: `<p><strong>O Dossiê:</strong> Durante a Guerra Fria, a CIA e o Exército americano financiaram o Projeto Stargate para recrutar e treinar 'visualizadores remotos' capazes de espionar instalações secretas soviéticas usando apenas o poder da mente.</p><p><strong>O Mistério:</strong> Embora cancelado oficialmente em 1995 sob alegação de falta de provas militares, documentos desclassificados revelam que os agentes paranormais obtiveram sucessos impressionantes e inexplicáveis na localização de reféns e submarinos ocultos.</p><p><em>Código do Vídeo para Desbloqueio: <strong>320, 500</strong></em></p>` }
    ],
    en: [
        ...
        { id: "pentagon_long", title: "The 160 Secret Pentagon Files", badge: "GOVERNMENT LEAKS", image: "images/ufo_investigation.png", shortDesc: "The official release of hundreds of pages of UFO sightings documented by elite military personnel.", readTime: "4 min read", fullContent: `<p><strong>The Dossier:</strong> In 2020, under strong pressure from the US Congress, the Pentagon officially released reports and sightings of Unidentified Anomalous Phenomena.</p><p><strong>The Mystery:</strong> Raw data and original radar tapes went missing shortly after the incidents. Reports detail impossible maneuvers and electromagnetic jamming.</p><p><em>Area 51 Access Passcode: <strong>SEGRETO51</strong></em></p>` },
        { id: "stargate", title: "The Stargate Project", badge: "SECRET PROJECT", image: "images/stargate_intro.png", shortDesc: "The secret US military unit that attempted to use remote viewing to spy on the Soviet Union.", readTime: "5 min read", fullContent: `<p><strong>The Dossier:</strong> During the Cold War, the CIA and the US Army funded the Stargate Project to recruit and train 'remote viewers' capable of spying on secret Soviet facilities using only the power of their minds.</p><p><strong>The Mystery:</strong> Although officially canceled in 1995 due to alleged lack of military value, declassified documents reveal that psychic agents achieved stunning and unexplained successes in locating hostages and hidden submarines.</p><p><em>Video Unlock Code: <strong>320, 500</strong></em></p>` }
    ],
    es: [
        ...
        { id: "pentagon_long", title: "Los 160 Archivos Secretos del Pentágono", badge: "FILTRACIONES GUBERNAMENTALES", image: "images/ufo_investigation.png", shortDesc: "La liberación oficial de cientos de páginas de avistamientos de OVNIs documentados por militares de élite.", readTime: "4 min de lectura", fullContent: `<p><strong>El Dosier:</strong> En 2020, bajo una fuerte presión del Congreso estadounidense, el Pentágono liberó oficialmente informes y avistamientos de Fenómenos Anómalos No Identificados.</p><p><strong>El Misterio:</strong> Los datos brutos y cintas de radar originales desaparecieron tras los incidentes. Los informes detallan maniobras imposibles e interferencias electromagnéticas.</p><p><em>Código de Acceso del Área 51: <strong>SEGRETO51</strong></em></p>` },
        { id: "stargate", title: "El Proyecto Stargate", badge: "PROYECTO SECRETO", image: "images/stargate_intro.png", shortDesc: "La unidade militar secreta de EE. UU. que intentó usar visión remota para espiar a la Unión Soviética.", readTime: "5 min de lectura", fullContent: `<p><strong>El Dosier:</strong> Durante la Guerra Fría, la CIA e el Ejército de EE. UU. financiaron el Proyecto Stargate para entrenar 'visores remotos' capaces de espiar instalaciones soviéticas con la mente.</p><p><strong>El Misterio:</strong> Aunque cancelado oficialmente en 1995, documentos desclasificados revelan que los visores psíquicos lograron éxitos inexplicables localizando rehenes y submarinos ocultos.</p><p><em>Código de Desbloqueo: <strong>320, 500</strong></em></p>` }
    ]
};
...
const decryptDatabaseData = {
    pt: {
        ...
        pentagon_long: { code: "SEGRETO51", title: "ARQUIVO PENTAGON_UAP // CONFIDENCIAL", date: "26/06/2026", content: `<p>Documentos desclassificados revelaram que pilotos de caça F-18 registraram bloqueios de radares causados por emissões eletromagnéticas desconhecidas vindo dos UAPs. Há menção de sumiço sistemático de dados brutos e fitas originais de radar imediatamente após os encontros.</p>` },
        stargate: { code: "320, 500", title: "ARQUIVO STARGATE_PSYCHIC // SECRETO", date: "27/06/2026", content: `<p>Relatórios internos da CIA confirmam que o visualizador Joseph McMoneagle descreveu com precisão um submarino de mísseis da classe Typhoon em construção dentro de um edifício fechado em Severodvinsk. Cientistas militares continuam investigando os limites da percepção extra-sensorial sob outros codinomes na Área 51.</p>` }
    },
    en: {
        ...
        pentagon_long: { code: "SEGRETO51", title: "FILE PENTAGON_UAP // CONFIDENTIAL", date: "26/06/2026", content: `<p>Declassified documents revealed F-18 fighter pilots recorded radar jamming caused by unknown electromagnetic emissions coming from UAPs. Systematic deletion of raw radar data and original tapes immediately after the encounters is noted.</p>` },
        stargate: { code: "320, 500", title: "FILE STARGATE_PSYCHIC // SECRET", date: "27/06/2026", content: `<p>Internal CIA reports confirm that remote viewer Joseph McMoneagle accurately described a giant Typhoon-class missile submarine under construction inside a closed building in Severodvinsk. Military scientists continue to investigate ESP limits under different codenames in Area 51.</p>` }
    },
    es: {
        ...
        pentagon_long: { code: "SEGRETO51", title: "ARCHIVO PENTAGON_UAP // CONFIDENCIAL", date: "26/06/2026", content: `<p>Documentos desclasificados revelaron que pilotos de F-18 registraron interferencias de radar causadas por emisiones electromagnéticas desconocidas de los UAPs. Se menciona la pérdida sistemática de datos brutos y cintas de radar tras los incidentes.</p>` },
        stargate: { code: "320, 500", title: "ARCHIVO STARGATE_PSYCHIC // SECRETO", date: "27/06/2026", content: `<p>Informes de la CIA confirman que el visor remoto Joseph McMoneagle describió con precisión un submarino Typhoon en construcción dentro de un hangar cerrado en Severodvinsk. Científicos militares continúan estudiando la percepción extrasensorial bajo otros nombres clave.</p>` }
    }
};
...
function changeLanguage(lang) {
    ...
    for (const key in translation) {
        // Convert camelCase key to kebab-case ID (e.g. siteTitle -> site-title, area51R1Title -> area51-r1-title)
        let id = key.replace(/([a-z0-9])([A-Z])/g, '$1-$2').toLowerCase();
        if (key === 'terminalCodePlaceholder') {
            id = 'terminal-code';
        } else if (key === 'area51PasscodePlaceholder') {
            id = 'area51-passcode';
        }
        ...
        // Also translate mobile menu drawer items
        if (id.startsWith('nav-')) {
            const mobileId = id.replace('nav-', 'mobile-');
            const mobileEl = document.getElementById(mobileId);
            if (mobileEl) {
                mobileEl.innerHTML = translation[key];
            }
        }
    }
